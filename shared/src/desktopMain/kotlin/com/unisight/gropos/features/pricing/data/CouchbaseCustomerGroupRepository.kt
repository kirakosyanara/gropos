...
/**
 * CouchbaseLite implementation of CustomerGroupRepository for Desktop (JVM).
 * 
...
class CouchbaseCustomerGroupRepository(
    ...
    override suspend fun getActiveGroups(): List<CustomerGroup> = withContext(Dispatchers.IO) {
        try {
            ...
            println("CouchbaseCustomerGroupRepository: Error getting active groups - ${e.message}")
            emptyList()
        }
    }
    ...
    override suspend fun getGroupById(groupId: Int): CustomerGroup? = withContext(Dispatchers.IO) {
        try {
            ...
            println("CouchbaseCustomerGroupRepository: Error getting group by ID $groupId - ${e.message}")
            null
        }
    }
    ...
    override suspend fun getGroupByName(name: String): CustomerGroup? = withContext(Dispatchers.IO) {
        try {
            ...
            println("CouchbaseCustomerGroupRepository: Error getting group by name '$name' - ${e.message}")
            null
        }
    }
    
    // ========================================================================
    // CustomerGroupDepartment Operations
    // ========================================================================
    ...
    override suspend fun getDepartmentDiscounts(groupId: Int): List<CustomerGroupDepartment> = withContext(Dispatchers.IO) {
        try {
            ...
            println("CouchbaseCustomerGroupRepository: Error getting department discounts for group $groupId - ${e.message}")
            emptyList()
        }
    }
    ...
    override suspend fun getDepartmentDiscount(groupId: Int, departmentId: Int): CustomerGroupDepartment? = withContext(Dispatchers.IO) {
        try {
            ...
            println("CouchbaseCustomerGroupRepository: Error getting department discount - ${e.message}")
            null
        }
    }
    
    // ========================================================================
    // CustomerGroupItem Operations
    // ========================================================================
    ...
    override suspend fun getItemDiscounts(groupId: Int): List<CustomerGroupItem> = withContext(Dispatchers.IO) {
        try {
            ...
            println("CouchbaseCustomerGroupRepository: Error getting item discounts for group $groupId - ${e.message}")
            emptyList()
        }
    }
    ...
    override suspend fun getItemDiscount(groupId: Int, branchProductId: Int): CustomerGroupItem? = withContext(Dispatchers.IO) {
        try {
            ...
            println("CouchbaseCustomerGroupRepository: Error getting item discount - ${e.message}")
            null
        }
    }
