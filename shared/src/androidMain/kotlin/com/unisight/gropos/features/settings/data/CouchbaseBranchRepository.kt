...
/**
 * CouchbaseLite implementation of BranchRepository for Android.
 * 
...
class CouchbaseBranchRepository(
    ...
    override suspend fun getAllBranches(): List<Branch> = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            android.util.Log.e("BranchRepository", "Error getting all branches: ${e.message}")
            emptyList()
        }
    }
    ...
    override suspend fun getBranchById(branchId: Int): Branch? = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            android.util.Log.e("BranchRepository", "Error getting branch by ID: ${e.message}")
            null
        }
    }
    ...
    override suspend fun getCurrentBranch(): Branch? = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            android.util.Log.e("BranchRepository", "Error getting current branch: ${e.message}")
        }
    ...
    private fun loadCurrentBranchIdFromPosSystem(): Int? {
        return try {
            ...
            android.util.Log.e("BranchRepository", "Error loading branch ID from PosSystem: ${e.message}")
            null
        }
    }
